<template>
  <section class="container">
    <div class="text-zone">
      ...
      <div class="bg" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);"><!--<img class="jb"
                                                                                    src="https://jacekjeznach.com/wp-content/themes/jj/img/jblue.png"
                                                                                    alt="Wordpress,  Developer Logo part9"
                                                                                    style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">-->
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt" height="457.000000pt"
               viewBox="0 0 300.000000 457.000000" preserveAspectRatio="xMidYMid meet" class=" drawsvg-initialized ">
              <g transform="translate(0.000000,457.000000) scale(0.100000,-0.100000)" stroke="#4d4d4e" stroke-width="10"
                 fill="none">
...
3 1 41 -59 84 -131z" style="stroke-dasharray: 40608.6, 40608.6; stroke-dashoffset: 0;"></path>
                  <path d="M1683 3265 c0 -8 4 -12 9 -9 5 3 6 10 3 15 -9 13 -12 11 -12 -6z"
                        style="stroke-dasharray: 61.131, 61.131; stroke-dashoffset: 0;"></path>
                  <path d="M289 1243 c-13 -16 -12 -17 4 -4 16 13 21 21 13 21 -2 0 -10 -8 -17
-17z" style="stroke-dasharray: 86.3521, 86.3521; stroke-dashoffset: 0;"></path>
              </g>
          </svg>
      </div>
  </section>
